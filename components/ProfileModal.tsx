        ...
        <div className="mt-5 flex flex-col gap-2.5 border-t border-white/10 pt-5">
          {profile.socials.map((social) => (
            <a
              ...
              className="grid grid-cols-[20px_1fr_20px] items-center gap-2 rounded border border-white/15 px-4 py-2.5 font-mono text-xs font-bold uppercase tracking-wider text-white/80 transition hover:border-scoreboard-amber hover:text-scoreboard-amber"
            >
              {/* Real brand logo from public/images/taglogo/. CSS background
                  degrades to an empty 20px slot if the file isn't in place yet,
